		  ...
		  <div class="main-carousel">
		    <ul class="carousel">
		      <?php foreach ($content['field_sections']['#items'] as $key => $item): ?>
		      	...
		      	?>
		        <li>
		          <div class="banner-content" data-style="background-image: url(<?php print image_style_url($item_fields['field_image'][0]['#image_style'], $item_fields['field_image'][0]['#item']['uri']) ?>);">
